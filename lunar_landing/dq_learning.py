...
class Agent():
    def __init__(self, gamma, epsilion, lr, input_dims, batch_size, n_actions, 
    max_mem_size=100000, eps_end=0.01, eps_dec=3e-4) -> None:
        ...
        self.Q_eval = DeepQNetwork(self.lr, self.input_dims, fc1_dims=256, fc2_dims=256, n_actions=n_actions)
    ...
    def learn(self):
        ...
        self.epsilion = self.epsilion - self.eps_dec if self.epsilion > self.eps_end else self.eps_end
